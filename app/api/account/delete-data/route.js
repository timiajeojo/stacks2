        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, firebaseAdmin_1.adminDb.recursiveDelete(firebaseAdmin_1.adminDb.collection("users").doc(uid))];
                case 3:
                    // Removes the user doc AND every subcollection underneath it
                    // (transactions, rentals) — the client SDK can't do this in one call.
                    _a.sent();
                ...
                case 4:
                    err_1 = _a.sent();
                    console.error("Account data deletion error:", err_1);
                    return [2 /*return*/, server_1.NextResponse.json({ error: "Server error deleting account data" }, { status: 500 })];
